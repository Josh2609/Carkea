...
<html>
    ...
    <body>
        ...
        <div>
            ...
            <button class = "profButton" type="button" onclick="showSearchResults(make, model, colour, fuel, carType, transType, numDoors, condition, mileLow, mileHigh, postcode, distance, priceLow, priceHigh)">Search</button> 
            <br><br>
			</div></div>
                <br><br>
            </div>
