...
<html>
    <head>
        ...
        <script src="js/showSoldSearchResults.js"></script>
        <title>Search Sold Cars</title>
        <script>
            var make = '%';
            var model = '%';
            var colour = '%';
    ...
    <body>
        ...
        <div>
            ...
            <div class="list">  
            <form method="POST"  action="include/getSoldCars.php">
                ...
                <tr>
                    ...
                    <td><input type="text" name="registration" placeholder="Registration" onchange="getRegistration(this)" style="width: 150px;height:25px;"></td>
            ...
            <button  class = "profButton" type="button" onclick="showSoldSearchResults(make, model, colour, fuel, carType, transType, numDoors, mileLow, mileHigh, priceLow, priceHigh, registration)">Search</button> 
            <br><br>
			</div></div>
                <br><br>
            </div>     
